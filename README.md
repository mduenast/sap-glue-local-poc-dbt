...
Run `make doctor` after creating the profile to check local readiness. It verifies Python 3, the local `.venv/bin/dbt` executable, `profiles.yml`, and whether `DUCKDB_PATH` is set.
